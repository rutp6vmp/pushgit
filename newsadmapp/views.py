...
from .filters import NewsUnitFilter

page1 = 1

def search(request):
	news = NewsUnit.objects.all()
	newsUnitFilter = NewsUnitFilter(queryset=news)
	if request.method == "POST":
		newsUnitFilter = NewsUnitFilter(request.POST, queryset=news)
	context = {
		'newsUnitFilter': newsUnitFilter
	}
